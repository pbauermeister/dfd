...
Execution with a try-it section, at the Retrospective after the
...
| 10  | Execution chapter: terse account, then "Try it" before stop 2                          | user review; placement: taste             | deviations and demo inside Closure  |
