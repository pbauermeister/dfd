...
### 1.3. Other diagrams (out of scope)
...
### 2.2. Creating connections between items
...
#### 2.5.2. Per-item or per-connection
...
### 3.2. Items rendered only if used (hidable)
...
### 3.6. Items and connections attributes

#### 3.6.1. Inline attributes
...
### 5.3. Including snippet without generating an image for the includee
...
### 6.1. Using dependencies

#### 6.1.1. Referring to another snippet
...
#### 6.1.2. Referring to another DFD file
